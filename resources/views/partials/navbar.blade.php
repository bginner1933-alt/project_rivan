<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top py-3">
    ...
    {{-- Brand Text --}}
    <span class="ls-tight">
        Wedding <span class="text-primary">Store</span>
    </span>
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            {{-- Search Form - Dibuat lebih lebar & modern --}}
            ...
            <ul class="navbar-nav ms-auto align-items-center gap-2">
                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 animate__animated animate__fadeIn animate__faster mt-2 py-2 rounded-4">
                            ...
                            <li>
                                <a class="dropdown-item py-2 px-3 rounded-3 mx-2 w-auto mb-1 hover-lift-sm" href="{{ route('profile.edit') }}">
                                    <i class="bi bi-person me-2 text-primary"></i> Profil Saya
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 px-3 rounded-3 mx-2 w-auto mb-1 hover-lift-sm" href="{{ route('orders.index') }}">
                                    <i class="bi bi-bag-check me-2 text-success"></i> Pesanan Saya
                                </a>
                            </li>
                            ...
                            @if(auth()->user()->isAdmin())
                                ...
                                <li>
                                    <a class="dropdown-item py-2 px-3 rounded-3 mx-2 w-auto mb-1 bg-soft-primary text-primary fw-bold" href="{{ route('admin.dashboard') }}">
                ...
                @else
                    {{-- Guest Links --}}
                    <li class="nav-item">
                        <a class="nav-link fw-medium px-3" href="{{ route('login') }}">Masuk</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn btn-primary rounded-pill px-4 shadow-sm hover-lift" href="{{ route('register') }}">
                            Daftar
                        </a>
                    </li>
                @endauth
